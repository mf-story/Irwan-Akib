...
title Buka Akses HP - Profil Dosen
echo ============================================================
echo   Menyiapkan akses dari HP (port 5533)
echo ============================================================

netsh advfirewall firewall show rule name="Profil Dosen 5533" >nul 2>nul
if errorlevel 1 (
  netsh advfirewall firewall add rule name="Profil Dosen 5533" dir=in action=allow protocol=TCP localport=5533
